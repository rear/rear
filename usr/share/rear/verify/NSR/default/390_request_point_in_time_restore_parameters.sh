# Ask for EMC NetWorker (Legato) Point-In-Time Restore.
...
# We are requesting point-in-time recovery just in case
# NSR_CLIENT_MODE = YES and NSR_CLIENT_REQUESTRESTORE = NO (explicitly)
