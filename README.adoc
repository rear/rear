...
To see the full list of authors and their contributions please look at the link:graphs/contributors[git history]. We are very thankful to all authors and encourage anybody interested to take a look at our source code and to contribute what you find important.
