...
When using _fish, ftp, ftps, hftp, http, https or sftp_, you can set *LFTP_PARAM* to pass additional parameters to _lftp_. For example: `LFTP_PARAM="set ftp:ssl-force true; set ftp:ssl-protect-data true;"`
